...
function App() {
  ...
  const handleEdit = (e, id) => {
    ...
    setTodo(t[0].todo)
    //for edit while exist one deleted
    ...
    <>
      ...
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-1/2">
        ...
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <button onClick={handleAdd} disabled={todo.length <= 3} className='bg-violet-800 hover:bg-violet-950 disabled:bg-violet-300 p-2 py-1 text-sm font-bold text-white rounded-md '>Save </button>
        </div>
